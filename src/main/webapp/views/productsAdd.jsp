		...
		<div class="row">
			<div class="col-sm-5">
				...
				<div class="form-group">
					...
					<select class="form-control border border-warning" name="categoryid" id="categoryDropdown" required onchange="validateCategory()">
...
<script type="text/javascript">
	...
	function validateCategory() {
		...
		categoryError.innerHTML = categoryDropdown.value === '' ? 'Please select a category.' : '';
	}
</script>
</body>
</html>
