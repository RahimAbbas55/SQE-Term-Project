...
class AdminControllerDiffblueTest {
    ...
    void testGetcategory() {
        ...
        //   test threw
        //   javax.servlet.ServletException: Circular view path [categories]: would dispatch back to the current handler URL [/admin/categories] again. Check your ViewResolver setup! (Hint: This may be the result of an unspecified view, due to default view name generation.)
    ...
    /**
     * Method under test:  {@link AdminController#deleteProduct(int)}
     */
    @Test
    void testDeleteProduct() throws Exception {
        when(productService.deleteProduct(anyInt())).thenReturn(true);
        MockHttpServletRequestBuilder postResult = MockMvcRequestBuilders.post("/admin/products/delete");
...
//    }
    ...
    /**
     * Method under test: {@link AdminController#removeCustomer(int)}
     */
    @Test
