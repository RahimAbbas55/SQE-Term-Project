...
class UserControllerDiffblueTest {
    ...
    /**
     * Method under test:  {@link UserController#getproduct(String)}
     */
    @Test
    ...
    /**
     * Method under test:
     * {@link UserController#updateUserProfile(int, String, String, String, String)}
     */
    @Test
    void testUpdateUserProfile() throws Exception {
        MockHttpServletRequestBuilder paramResult = MockMvcRequestBuilders.post("/updateuser")
                .param("address", "foo")
                .param("email", "foo")
                .param("password", "foo");
